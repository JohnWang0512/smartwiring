...
//    }
    ...
    mainController.ddmenuVC = rootController;
...
-(void)initDemoData
{
    ...
    NSString *sMac = [Global byteMacToString:t];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SmartWiring" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SmartWiring.sqlite"];
